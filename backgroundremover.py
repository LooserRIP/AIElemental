...
for file in Path(r'G:\koren\stablediffusion\stable-diffusion-webui\outputs\txt2img-images\2023-05-01').glob('*.png'):
    ...
    #os.remove(file)
    igt += 1
for file in Path(r'G:\koren\stablediffusion\stable-diffusion-webui\outputs\txt2img-images\2023-05-02').glob('*.png'):
    nameget = config['elements'][igt]['stripped']
    input_path = str(file)
    print(igt, nameget)
    output_path = str(r'C:\Users\User\Documents\GitHub\AIElemental\cdn\IconsStyle\\' + (nameget + ".png"))
...
for file in Path(r'G:\koren\stablediffusion\stable-diffusion-webui\outputs\txt2img-images\2023-05-03').glob('*.png'):
    nameget = config['elements'][igt]['stripped']
    input_path = str(file)
    print(igt, nameget)
    output_path = str(r'C:\Users\User\Documents\GitHub\AIElemental\cdn\IconsStyle\\' + (nameget + ".png"))
